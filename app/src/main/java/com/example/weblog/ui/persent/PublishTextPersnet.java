...
public class PublishTextPersnet {




    public void postCreatText(final OnPostCreatTextListener listener, final Map<String,String> paramsMap) {
        //开启线程，发送请求
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    String baseUrl = "http://47.101.132.233:8099/api/user/article";
                    //合成参数
